...
export default function SettingsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-5">
      ...
      <p className="mt-1 text-sm text-gray-500">Personalize this device. Identity policy remains controlled by the platform administrator.</p>
      ...
      <section className="mt-3 rounded-card border border-silver-mid/60 bg-white p-4 shadow-resting">
        ...
        {([
          ...
          ["moderationUpdates", "Submission decisions", "Show status changes and revision requests."],
