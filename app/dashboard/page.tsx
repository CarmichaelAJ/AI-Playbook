  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="hero-af text-white px-5 pt-5 pb-5 overflow-hidden rounded-b-[24px]">
        ...
        <h1 className="font-display text-2xl font-bold uppercase tracking-wider mb-1">HQ</h1>
        <p className="text-sm text-on-dark">
          Your headquarters: your saved plays, the approved launchpads, and the official picture — every strategy,
          memo, and door, dated and translated.
        </p>
      </div>
